...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Rian Hidayat Saputra</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                <p>
                  Rian Hidayat Saputra - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{route('absen')}}">
            <i class="fa fa-address-book"></i> <span>Absen</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022-2023 <a href="https://adminlte.io">Rian Hidayat Saputra</a>.</strong> All rights
    reserved.
  </footer>
